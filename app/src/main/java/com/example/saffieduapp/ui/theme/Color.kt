...
val AppAccent = Color(0xFF6FCF97)        // لون مميز (Accent)
val AppTextPrimary = Color(0xFF333333)   // لون الخط الأساسي
val AppTextSecondary = Color(0xFF828282) // لون ثانوي للنصوص
