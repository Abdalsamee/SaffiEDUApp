...
sealed interface AddQuestionEvent {
    ...
    data class ChoiceTextChanged(val choiceId: String, val text: String) : AddQuestionEvent // تغيير من Long إلى String
    data class CorrectChoiceSelected(val choiceId: String) : AddQuestionEvent // تغيير من Long إلى String
    data object AddChoiceClicked : AddQuestionEvent
    data class RemoveChoiceClicked(val choiceId: String) : AddQuestionEvent // تغيير من Long إلى String
